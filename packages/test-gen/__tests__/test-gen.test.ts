  ...
  screens: [
    {
      ...
      components: [
        {
          id: 'c1',
          platformType: 'TextField',
          name: 'SearchBar',
          props: { accessibilityIdentifier: 'searchBar' },
          style: {},
          testId: 'searchBar',
        },
        {
          id: 'c2',
          platformType: 'LazyVGrid',
          name: 'PetGrid',
          props: { accessibilityIdentifier: 'petGrid' },
          style: {},
          testId: 'petGrid',
        },
      ],
    ...
    },
    {
      ...
      components: [
        {
          id: 'c3',
          platformType: 'AsyncImage',
          name: 'PetImage',
          props: { accessibilityIdentifier: 'petImage' },
          style: {},
          testId: 'petImage',
        },
        {
          ...
          platformType: 'Button',
          name: 'AdoptButton',
          props: { accessibilityIdentifier: 'adoptButton' },
          style: {},
          testId: 'adoptButton',
        },
      ],
