...
describe('FigmaRestClient', () => {
  function mockFetch(responses: Array<{ ok: boolean; json?: unknown; text?: string; arrayBuffer?: ArrayBuffer }>) {
    let callIndex = 0
    ...
    document: {
      ...
      children: [{
        ...
        children: [{
          ...
          type: 'FRAME',
          children: [
            { id: '3:0', name: 'Title', type: 'TEXT', characters: 'Hello World' },
          ],
        }],
      }],
    },
  ...
  describe('getDesignContext', () => {
    ...
    it('throws on API error', async () => {
      ...
      await expect(client.getDesignContext({
        fileUrl: 'https://www.figma.com/design/ABC123/Test',
