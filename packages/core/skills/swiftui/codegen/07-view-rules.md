...
- The root container (ContentView) MUST apply `.background(Color(...).ignoresSafeArea())` so the app background extends edge-to-edge behind the status bar and home indicator. Without this, the app will show black bars at the top and bottom.
